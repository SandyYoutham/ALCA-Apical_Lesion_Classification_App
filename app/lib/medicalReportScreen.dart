...
class medicalReportScreen extends StatefulWidget {
  ...
  medicalReportScreen({super.key,required this.imageFile,required this.user});
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  SizedBox(width: 20,),
                  Text("Apical",style: TextStyle(color: Color(0xff2699a1),fontWeight: FontWeight.bold,fontSize: 20),),
                ],
              ),
              SizedBox(height: 20,),
              Row(
